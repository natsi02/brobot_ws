...
# facenet 
# from std_msgs.msg import String
class brobot_hand_gesture_recognition(Node):
    def __init__(self):
        super().__init__('hand_gesture')
        self.model_dict = pickle.load(open('/home/natsi02/brobot_ws/src/brobot_controller/model/model.p', 'rb'))
...
def main(args=None):
    ...
    node = brobot_hand_gesture_recognition()
    rclpy.spin(node)
    node.destroy_node()
    rclpy.shutdown()
